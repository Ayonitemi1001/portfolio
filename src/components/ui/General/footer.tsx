...
export default function Footer() {
  ...
  return (
    <footer className="bg-cyan-900 border-t border-cyan-900/30 pt-16 pb-24">
...
function SocialLink({ href, icon }: { href: string; icon: React.ReactNode }) {
  return (
    <a 
      ...
      className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-lg bg-[#1f1f3a] text-gray-400 hover:bg-cyan-600 hover:text-white hover:-translate-y-1 transition-all duration-300 shadow-md hover:shadow-cyan-500/20"
    >
      {icon}
    </a>
  );
