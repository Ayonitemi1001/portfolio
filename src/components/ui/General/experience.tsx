...
export default function Experience() {
  return (
    <section id='experience' className='relative z-10 flex flex-col justify-center items-center mt-20 px-4 sm:px-0'>
        
        {/* Header */}
         <div className='flex flex-col space-y-2 mb-10 text-center'>
            <h2 className='text-gray-500 text-sm font-bold tracking-wide'>What Skills I have</h2>
