...
export const services: ServiceData[] = [
  {
    ...
    description:
      "Developing high-performance web apps with a focus on real-time data and security.",
    items: [
  ...
  },
  {
    ...
    description:
      "Transforming designs into pixel-perfect, responsive interfaces with a focus on user experience.",
    items: [
